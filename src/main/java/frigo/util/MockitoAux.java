...
public class MockitoAux {
    ...
    public static class UnstubbedInvocationInvoked extends MockitoAssertionError {
    ...
    public static class ImplicitVerificationFailed extends MockitoAssertionError {
