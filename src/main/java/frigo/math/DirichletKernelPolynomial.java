...
public class DirichletKernelPolynomial {
    ...
    public static Polynomial dirichlet (int n) {
        Polynomial dirichlet = ChebyshevPolynomial.chebyshev(0);
        for( int i = 1; i <= n; i++ ){
            dirichlet = dirichlet.add(ChebyshevPolynomial.chebyshev(i).mul(2.0));
        }
        return dirichlet;
    }
    ...
    public static Polynomial modifiedDirichlet (int n) {
        Polynomial dirichlet = ChebyshevPolynomial.chebyshev(0).add(ChebyshevPolynomial.chebyshev(n)).mul(0.5);
        for( int i = 1; i < n; i++ ){
            dirichlet = dirichlet.add(ChebyshevPolynomial.chebyshev(i));
        }
