...
public class Resistor extends Element {
    ...
    private static final double[] DECADES = {1, 10, 100, toUnit("1k"), toUnit("10k"), toUnit("100k"), toUnit("1M")};

    public static final double[] E6_RESISTORS = applyDecades(E6, DECADES);
    public static final double[] E12_RESISTORS = applyDecades(E12, DECADES);
    public static final double[] E24_RESISTORS = applyDecades(E24, DECADES);
    public static final double[] E48_RESISTORS = applyDecades(E48, DECADES);
    public static final double[] E96_RESISTORS = applyDecades(E96, DECADES);
    public static final double[] E192_RESISTORS = applyDecades(E192, DECADES);
