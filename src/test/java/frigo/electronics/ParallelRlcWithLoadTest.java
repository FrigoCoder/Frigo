...
public class ParallelRlcWithLoadTest {
    ...
    public void test_peak_and_midpoints_of_a_known_filter () {
        ...
        assertThat(rlc.f1(), is(1458.2758992652366));
        assertThat(rlc.f2(), is(17029.44103668042));

        assertThat(rlc.response(rlc.f0()), is(-10.48467598730607));
        assertThat(rlc.response(rlc.f1()), is(-7.484675987306075));
        assertThat(rlc.response(rlc.f2()), is(-7.484675987306075));
        assertThat(rlc.q(), is(0.3200360747922945));
    }
}
