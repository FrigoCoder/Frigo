...
public class ReflectionTest {
    ...
    @Test
    public void setStaticField_sets_value_of_private_static_field_of_subclass () {
        setStaticField(sub.getClass(), "anotherPrivateStaticField", 116);
        assertThat(Sub.anotherPrivateStaticField, is(116));
    }

    @Test
    public void getField_throws_exception_on_unknown_field () {
        thrown.expect(NoSuchFieldException.class);
        Reflection.<Integer>getField(base, "doesNotExist");
    }

    @Test
    public void getStaticField_throws_exception_on_unknown_field () {
        thrown.expect(NoSuchFieldException.class);
        Reflection.<Integer>getStaticField(base.getClass(), "doesNotExist");
    }

    @Test
    public void setField_throws_exception_on_unknown_field () {
        thrown.expect(NoSuchFieldException.class);
        Reflection.<Integer>setField(base, "doesNotExist", 1);
    }

    @Test
    public void setStaticField_throws_exception_on_unknown_field () {
        thrown.expect(NoSuchFieldException.class);
